...
BUBBLE_CHANCE = 10
# Сума набраних очок (обнуляємо на початку гри)
score = 0
while True:
    ...
    move_bubbles()
    clean_up_bubbles()
    score += collision() # Додаємо очки за знищені бульбашки до загального рахунку
    print(score) # Виводимо на консоль рахунок
    window.update()
    time.sleep(0.01)
