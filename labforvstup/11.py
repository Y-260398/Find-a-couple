...
import random
import time
import math # Підключаємо математичний модуль
...
# Функція, що обчислює відстань між двома об’єктами
def distance(id1,id2):
    x1, y1 = get_coords(id1) # Координати першого об’єкта
    x2, y2 = get_coords(id2) # Координати другого об’єкта
    return math.sqrt((x2-x1)**2+(y2-y1)**2) # Повертаємо відстань між об’єктами
