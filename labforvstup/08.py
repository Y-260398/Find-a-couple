...
c = Tkinter.Canvas(window, width=WIDTH, height=HEIGHT, bg=Tkinter.image.load('2.png'))
c.pack()
...
# Функція знищення бульбашки
def del_bubble(id):
    # Видаляємо дані про бульбашку зі списків
    del bubble_radius[id]
    del bubble_speed[id]
    # Та видаляємо її з полотна
