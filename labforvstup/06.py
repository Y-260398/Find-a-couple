...
# Шанс появи нової бульбашки
BUBBLE_CHANCE = 10
#Головний цикл гри
while True:
    # Створюємо нову бульбашку з заданою ймовірністю
    if random.randint(1, BUBBLE_CHANCE) == 1:
        create_bubble()
    # Рухаємо всі бульбашки
    move_bubbles()
    # Оновлюємо зображення
    window.update()
    # Часова затримка (сповільнюємо гру, щоб грати було не надто складно)
    time.sleep(0.01)
